...
export default function Sidebar() {
  ...
  return (
    <div className="bg-mainBack h-screen w-[284px] border-r border-borderColor flex flex-col ">
      ...
      <div className="w-full mt-auto h-[115px] py-[36px] px-[24px] border-t  border-borderColor  flex items-center justify-evenly">
        <img
        ...
        <NotificationSVG className="fill-baseColor hover:fill-selectedItem cursor-pointer" />
        <DetailsSVG className="fill-baseColor hover:fill-selectedItem cursor-pointer" />
      </div>
    </div>
  );
}
